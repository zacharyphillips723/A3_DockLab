    ...
    truth = pd.DataFrame(
        {
            ...
            "target_qw": _interp(source, "target_qw", truth_times),
            "target_qx": _interp(source, "target_qx", truth_times),
            "target_qy": _interp(source, "target_qy", truth_times),
            "target_qz": _interp(source, "target_qz", truth_times),
